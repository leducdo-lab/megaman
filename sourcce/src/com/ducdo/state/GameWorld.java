...
import com.ducdo.effect.FrameImage;
import com.ducdo.gameobject.BackgroundMap;
import com.ducdo.gameobject.BulletManager;
import com.ducdo.gameobject.Camera;
import com.ducdo.gameobject.DarkRaise;
import com.ducdo.gameobject.FinalBoss;
import com.ducdo.gameobject.Megaman;
import com.ducdo.gameobject.ParticularObject;
import com.ducdo.gameobject.ParticularObjectManager;
import com.ducdo.gameobject.PhysicalMap;
import com.ducdo.gameobject.RedEyeDevil;
import com.ducdo.gameobject.RobotR;
import com.ducdo.gameobject.SmallRedGun;
...
public class GameWorld extends State{
	...
	public GameWorld(GamePanel gamePanel) {
        ...
        camera = new Camera(0, 50, GameFrame.SCREEN_WIDTH, GameFrame.SCREEEN_HEIGHT, this);
        ...
        initEnemies();
        bgMusic = CacheDataLoader.getInstance().getSounds("bgmusic");
            ...
            case MEETFINALBOSS:
                if (storyTutorial == 0) {
                    ...
                    if (openIntroGameY < 450 && camera.getPosX() >= finalBossX && megaman.getPosX() >= finalBossX + 150) {
                        ...
                        backgroundMap.backmap[14][120] = 17;
                        backgroundMap.backmap[15][120] = 17;
                        backgroundMap.backmap[16][120] = 17;
                        backgroundMap.backmap[17][120] = 17;
                    }
                } else {
                    if (currentSize < textTutorial.length()) currentSize++;
                }
    ...
    private void TutorialRender(Graphics2D g2) {
        switch (tutorialState) {
            case INTROGAME:
                int yMid = GameFrame.SCREEEN_HEIGHT / 2 - 15;
                int y1 = yMid - GameFrame.SCREEEN_HEIGHT / 2 - openIntroGameY / 2;
                int y2 = yMid + openIntroGameY / 2;

                g2.setColor(Color.BLACK);
                g2.fillRect(0, y1, GameFrame.SCREEN_WIDTH, GameFrame.SCREEEN_HEIGHT / 2);
                g2.fillRect(0, y2, GameFrame.SCREEN_WIDTH, GameFrame.SCREEEN_HEIGHT / 2);
                ...
                break;
            case MEETFINALBOSS:
                yMid = GameFrame.SCREEEN_HEIGHT / 2 - 15;
                y1 = yMid - GameFrame.SCREEEN_HEIGHT / 2 - openIntroGameY / 2;
    ...
    public void Render() {
        ...
        if (g2 != null) {
            switch (state) {
                case INIT_GAME:
                    g2.setColor(Color.BLACK);
                    g2.fillRect(0, 0, GameFrame.SCREEN_WIDTH, GameFrame.SCREEEN_HEIGHT);
                    g2.setColor(Color.WHITE);
